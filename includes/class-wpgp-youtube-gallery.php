...
class WPGP_YouTube_Gallery {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'plugin_action_links', $plugin_admin_cpt, 'wpgp_add_action_plugin', 10, 5 );
		...
		$this->loader->add_filter( 'manage_wpgp_youtube_gallery_posts_columns', $plugin_admin_cpt, 'wpgp_admin_column' );
		$this->loader->add_action( 'manage_wpgp_youtube_gallery_posts_custom_column', $plugin_admin_cpt, 'wpgp_admin_field', 10, 2 );
	...
	private function define_public_hooks() {
		...
		add_shortcode( 'wptube', array( $plugin_shortcode, 'wpgp_shortcode_execute' ) );
