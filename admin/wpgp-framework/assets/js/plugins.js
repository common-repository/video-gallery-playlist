...
(function($) {
  ...
  WPGPAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wpgp-hide-select');
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wpgp-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // PLUGINIC: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // PLUGINIC: Renamed function names for avoid conflicts
  //
