...
;(function( $, window, document, undefined ) {
  ...
  $.fn.wpgp_nav_options = function() {
    return this.each( function() {
      ...
      $window.on('hashchange wpgp.hashchange', function() {
        ...
        if ( $link.length ) {
          ...
          $link.closest('.wpgp-tab-item').addClass('wpgp-tab-expanded').siblings().removeClass('wpgp-tab-expanded');
          ...
          $links.removeClass('wpgp-active');
          $link.addClass('wpgp-active');
          ...
          $('.wpgp-section-id').val( $section.index()+1 );
  ...
  $.fn.wpgp_nav_metabox = function() {
    return this.each( function() {
      ...
      var $nav      = $(this),
          $links    = $nav.find('a'),
          $sections = $nav.parent().find('.wpgp-section'),
          $last;
  ...
  $.fn.wpgp_page_templates = function() {
    if ( this.length ) {
      ...
      $(document).on('change', '.editor-page-attributes__template select, #page_template', function() {
        ...
        $('.wpgp-page-templates').removeClass('wpgp-metabox-show').addClass('wpgp-metabox-hide');
        $('.wpgp-page-'+maybe_value.toLowerCase().replace(/[^a-zA-Z0-9]+/g,'-')).removeClass('wpgp-metabox-hide').addClass('wpgp-metabox-show');
  ...
  $.fn.wpgp_post_formats = function() {
    if ( this.length ) {
      ...
      $(document).on('change', '.editor-post-format select, #formatdiv input[name="post_format"]', function() {
        ...
        $('.wpgp-post-formats').removeClass('wpgp-metabox-show').addClass('wpgp-metabox-hide');
        $('.wpgp-post-format-'+maybe_value).removeClass('wpgp-metabox-hide').addClass('wpgp-metabox-show');
    ...
    return this.each( function() {
      ...
      $input.on('change keyup', function() {
        ...
        var value    = $(this).val(),
            ...
            $fields  = $section.find('> .wpgp-field:not(.wpgp-depend-on)'),
            $titles  = $fields.find('> .wpgp-title, .wpgp-search-tags');

        if ( value.length > 3 ) {

          $fields.addClass('wpgp-metabox-hide');
          ...
          $titles.each( function() {
            ...
            if ( $title.text().match( new RegExp('.*?' + value + '.*?', 'i') ) ) {
              ...
              $field.removeClass('wpgp-metabox-hide');
          ...
          $fields.removeClass('wpgp-metabox-hide');
  ...
  $.fn.wpgp_dependency = function() {
    return this.each( function() {
      ...
      if( $fields.length ) {
        ...
        var normal_ruleset = $.wpgp_deps.createRuleset(),
            global_ruleset = $.wpgp_deps.createRuleset(),
            normal_depends = [],
            global_depends = [];
        ...
        if ( normal_depends.length ) {
          $.wpgp_deps.enable($this, normal_ruleset, normal_depends);
        }

        if ( global_depends.length ) {
          $.wpgp_deps.enable(WPGP.vars.$body, global_ruleset, global_depends);
        }
      ...
      $import.on('click', function( e ) {
        ...
        if ( WPGP.vars.is_confirm ) {
          ...
          window.wp.ajax.post( 'wpgp-import', {
            ...
            data: $this.find('.wpgp-import-data').val()
          }).done( function( response ) {
            window.location.reload(true);
          }).fail( function( response ) {
            alert( response.error );
  ...
  $.fn.wpgp_field_background = function() {
    return this.each( function() {
      $(this).find('.wpgp--background-image').wpgp_reload_script();
    });
  };
  ...
  // Field: datetime
  //
  $.fn.wpgp_field_datetime = function() {
    return this.each( function() {

      var $this    = $(this),
          $inputs  = $this.find('input'),
          settings = $this.find('.wpgp-datetime-settings').data('settings');

      settings = $.extend({}, settings, {
        onReady: function( selectedDates, dateStr, instance) {
          $(instance.calendarContainer).addClass('wpgp-flatpickr');
        },
      });
  ...
  $.fn.wpgp_field_group = function() {
    return this.each( function() {
      ...
      $wrapper.accordion({
        ...
        heightStyle: 'content',
        icons: {
          'header': 'wpgp-cloneable-header-icon fas fa-angle-right',
          'activeHeader': 'wpgp-cloneable-header-icon fas fa-angle-down'
        },
        activate: function( event, ui ) {
          ...
          if ( $panel.length && !$panel.data( 'opened' ) ) {
            ...
            $.each(inputs, function( key, $input ) {
              ...
              $input.on('change keyup wpgp.keyup', function() {
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_item    = $('<div class="wpgp-cloneable-item" />');
        ...
        if ( !WPGP.vars.icon_modal_loaded ) {
          ...
          window.wp.ajax.post( 'wpgp-get-icons', {
            ...
            $load.on('click', 'i', function( e ) {
              ...
              WPGP.vars.$icon_target.find('.wpgp-icon-preview i').removeAttr('class').addClass(icon);
  ...
  // Field: icon SVG
  //
  $.fn.wpgp_field_icon_svg = function() {
    return this.each( function() {

      var $this = $(this);

      $this.on('click', '.wpgp-icon-add-svg', function( e ) {
        ...
        if ( !WPGP.vars.icon_modal_loaded ) {
          ...
          window.wp.ajax.post( 'wpgp-get-icons-svg', {
            nonce: $button.data('nonce')
          }).done( function( response ) {
            ...
            $load.on('click', 'span', function( e ) {

              e.preventDefault();

              var icon = $(this).html();

              WPGP.vars.$icon_target.find('.wpgp-icon-preview').html(icon);
              WPGP.vars.$icon_target.find('.wpgp-icon-preview').removeClass('hidden');
              WPGP.vars.$icon_target.find('.wpgp-icon-remove').removeClass('hidden');
              WPGP.vars.$icon_target.find('input').val(icon).trigger('change');
  ...
  // Field: map
  //
  $.fn.wpgp_field_map = function() {
    return this.each( function() {

      if ( typeof L === 'undefined' ) { return; }

      var $this         = $(this),
          $map          = $this.find('.wpgp--map-osm'),
          $search_input = $this.find('.wpgp--map-search input'),
          $latitude     = $this.find('.wpgp--latitude'),
          $longitude    = $this.find('.wpgp--longitude'),
          $zoom         = $this.find('.wpgp--zoom'),
      ...
      if ( ! $search_input.length ) {
        $search_input = $( '[data-depend-id="'+ $this.find('.wpgp--address-field').data( 'address-field' ) +'"]' );
      }
      ...
      $search_input.autocomplete({
        ...
        create: function (event, ui) {
          $(this).autocomplete('widget').addClass('wpgp-map-ui-autocomplate');
        }
      });
  ...
  // Field: link
  //
  $.fn.wpgp_field_link = function() {
    return this.each( function() {

      var $this   = $(this),
          $link   = $this.find('.wpgp--link'),
          $add    = $this.find('.wpgp--add'),
          $edit   = $this.find('.wpgp--edit'),
          $remove = $this.find('.wpgp--remove'),
          $result = $this.find('.wpgp--result'),
          uniqid  = WPGP.helper.uid('wpgp-wplink-textarea-');
      ...
      $edit.on('click', function( e ) {
        ...
        $('#wp-link-url').val($this.find('.wpgp--url').val());
        $('#wp-link-text').val($this.find('.wpgp--text').val());
        $('#wp-link-target').prop('checked', ($this.find('.wpgp--target').val() === '_blank'));
      ...
      $remove.on('click', function( e ) {
        ...
        $this.find('.wpgp--url').val('').trigger('change');
        $this.find('.wpgp--text').val('');
        $this.find('.wpgp--target').val('');
      ...
      $link.attr('id', uniqid).on('change', function() {
        ...
        $this.find('.wpgp--url').val(href).trigger('change');
        $this.find('.wpgp--text').val(text);
        $this.find('.wpgp--target').val(target);
  ...
  $.fn.wpgp_field_media = function() {
    return this.each( function() {
      ...
      var $this            = $(this),
          ...
          $auto_attributes = ( $this.hasClass('wpgp-assign-field-background') ) ? $this.closest('.wpgp-field-background').find('.wpgp--auto-attributes') : false,
          wp_media_frame;
      ...
      $upload_button.on('click', function( e ) {
        ...
        wp_media_frame.on( 'select', function() {
          ...
          if ( $auto_attributes ) {
            $auto_attributes.removeClass('wpgp--attributes-hidden');
          }
      ...
      $remove_button.on('click', function( e ) {
        ...
        if ( $auto_attributes ) {
          $auto_attributes.addClass('wpgp--attributes-hidden');
        }
    ...
    return this.each( function() {
      ...
      var event_clone = function( e ) {
        ...
        var $this           = $(this),
            ...
            $cloned_item    = $('<div class="wpgp-repeater-item" />');
  ...
  $.fn.wpgp_field_spinner = function() {
    return this.each( function() {
      ...
      $input.spinner({
        ...
        create: function( event, ui ) {
          if ( data.unit ) {
            $input.after('<span class="ui-button wpgp--unit">'+ data.unit +'</span>');
          }
        },
  ...
  $.fn.wpgp_field_tabbed = function() {
    return this.each( function() {
      ...
      var $this     = $(this),
          ...
          $contents = $this.find('.wpgp-tabbed-content');

      $contents.eq(0).wpgp_reload_script();
  ...
  $.fn.wpgp_field_upload = function() {
    return this.each( function() {
      ...
      var $this          = $(this),
          ...
          $upload_button = $this.find('.wpgp--button'),
          $remove_button = $this.find('.wpgp--remove'),
          $preview_wrap  = $this.find('.wpgp--preview'),
          $preview_src   = $this.find('.wpgp--src'),
          $library       = $upload_button.data('library') && $upload_button.data('library').split(',') || '',
          wp_media_frame;
              ...
              if ( Object.keys( response.errors ).length ) {
                ...
                $.each(response.errors, function( key, error_message ) {
                  ...
                  var $field = $('[data-depend-id="'+ key +'"]'),
                      $link  = $('a[href="#tab='+ $field.closest('.wpgp-section').data('section-id') +'"]' ),
                      $tab   = $link.closest('.wpgp-tab-item');

                  $field.closest('.wpgp-fieldset').append( '<p class="wpgp-error wpgp-error-text">'+ error_message +'</p>' );
  ...
  // Option Framework
  //
  $.fn.wpgp_options = function() {
    return this.each( function() {

      var $this         = $(this),
          $content      = $this.find('.wpgp-content'),
          $form_success = $this.find('.wpgp-form-success'),
          $form_warning = $this.find('.wpgp-form-warning'),
          $save_button  = $this.find('.wpgp-header .wpgp-save');

      WPGP.vars.$form_warning = $form_warning;

      // Shows a message white leaving theme options without saving
      if ( $form_warning.length ) {

        window.onbeforeunload = function() {
          return ( WPGP.vars.form_modified ) ? true : undefined;
        };

        $content.on('change keypress', ':input', function() {
          if ( !WPGP.vars.form_modified ) {
            $form_success.hide();
            $form_warning.fadeIn('fast');
            WPGP.vars.form_modified = true;
          }
        });

      }

      if ( $form_success.hasClass('wpgp-form-show') ) {
        setTimeout( function() {
  ...
  $.fn.wpgp_shortcode = function() {
    ...
    return this.each( function() {
      ...
      $insert.on('click', function( e ) {
        ...
        var shortcode = '';
        var serialize = $modal.find('.wpgp-field:not(.wpgp-depend-on)').find(':input:not(.ignore)').serializeObjectWPGP();
        ...
        create: function() {
          ...
          var a8cIris = $input.data('a8cIris'),
              $transparent_wrap = $('<div class="wpgp--transparent-wrap">' +
                                ...
                                '<div class="wpgp--transparent-button">transparent <i class="fas fa-toggle-off"></i></div>' +
  ...
  $.fn.wpgp_chosen = function() {
    return this.each( function() {
      ...
      if ( is_multiple ) {
        ...
        var $hidden_select = $this.parent().find('.wpgp-hide-select');
      ...
      if ( is_sortable ) {
        ...
        $chosen_choices.sortable({
          ...
          update: function( e, ui ) {
            ...
            var $prev_select   = $this.parent().find('.wpgp-hide-select');
  ...
  $.fn.wpgp_customizer_listen = function( options ) {
    ...
    return this.each( function() {
      ...
      $input.on('change keyup wpgp.change', function() {
  ...
  $.fn.wpgp_widgets = function() {
    return this.each( function() {
      ...
      $(document).on('widget-added widget-updated', function( event, $widget ) {
        ...
        var $fields = $widget.find('.wpgp-fields');

        if ( $fields.length ) {
          $fields.wpgp_reload_script();
        }
      ...
      $(document).on('click', '.widget-top', function( event ) {
        ...
        var $fields = $(this).parent().find('.wpgp-fields');
  ...
  //
  $.fn.wpgp_nav_menu = function() {
    return this.each( function() {

      var $navmenu = $(this);

      $navmenu.on('click', 'a.item-edit', function() {
        $(this).closest('li.menu-item').find('.wpgp-fields').wpgp_reload_script();
      });
  ...
  $.fn.wpgp_reload_script = function( options ) {
    ...
    return this.each( function() {
      ...
      if ( !$this.data('inited') ) {
        ...
        $this.children('.wpgp-field-datetime').wpgp_field_datetime();
        ...
        $this.children('.wpgp-field-icon_svg').wpgp_field_icon_svg();
        $this.children('.wpgp-field-link').wpgp_field_link();
        $this.children('.wpgp-field-media').wpgp_field_media();
        $this.children('.wpgp-field-map').wpgp_field_map();
  ...
  $(document).ready( function() {
    ...
    $('#widgets-editor').wpgp_widgets();
    $('#widgets-right').wpgp_widgets();
    $('#menu-to-edit').wpgp_nav_menu();
