...
WPGP::createOptions(
	$prefix,
	array(
		'framework_title'    => __( '<img src="' . WPGP_YOUTUBE_GALLERY_DIR_URL_FILE . 'admin/img/icon-128x128.png"><span>Gallery For YouTube - Global Settings</span>', 'wpgp-youtube-gallery' ),
