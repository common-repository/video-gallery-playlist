 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WPGP_Field_color' ) ) {
	class WPGP_Field_color extends WPGP_Fields {
		...
		public function render() {
			...
			echo '<input type="text" name="' . esc_attr( $this->field_name() ) . '" value="' . esc_attr( $this->value ) . '" class="wpgp-color"' . wp_kses_post( $default_attr . $this->field_attributes() ) . '/>';
