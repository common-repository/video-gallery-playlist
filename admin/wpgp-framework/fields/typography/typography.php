...
if ( ! class_exists( 'WPGP_Field_typography' ) ) {
	class WPGP_Field_typography extends WPGP_Fields {
		...
		public function render() {
			...
			echo '<div class="wpgp--typography' . esc_attr( $chosen_class ) . '" data-depend-id="' . esc_attr( $this->field['id'] ) . '" data-unit="' . esc_attr( $args['unit'] ) . '" data-line-height-unit="' . esc_attr( $line_height_unit ) . '" data-exclude="' . esc_attr( $args['exclude'] ) . '">';
			...
			if ( ! empty( $args['font_size'] ) ) {
				...
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[font-size]' ) ) . '" class="wpgp--font-size wpgp--input wpgp-input-number" value="' . esc_attr( $this->value['font-size'] ) . '" step="any" />';
			...
			if ( ! empty( $args['line_height'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[line-height]' ) ) . '" class="wpgp--line-height wpgp--input wpgp-input-number" value="' . esc_attr( $this->value['line-height'] ) . '" step="any" />';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[letter-spacing]' ) ) . '" class="wpgp--letter-spacing wpgp--input wpgp-input-number" value="' . esc_attr( $this->value['letter-spacing'] ) . '" step="any" />';
				echo '<span class="wpgp--unit">' . esc_attr( $args['unit'] ) . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[word-spacing]' ) ) . '" class="wpgp--word-spacing wpgp--input wpgp-input-number" value="' . esc_attr( $this->value['word-spacing'] ) . '" step="any" />';
				echo '<span class="wpgp--unit">' . esc_attr( $args['unit'] ) . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( $is_google ) {
				...
				if ( $font_weight || $font_style ) {
					...
					if ( ! empty( $style ) ) {
						...
						WPGP::$webfonts[ $method ][ $font_family ][ $style ] = $style;
					}
				} else {
					WPGP::$webfonts[ $method ][ $font_family ] = array();
				}
				...
				if ( ! empty( $this->value['extra-styles'] ) ) {
					foreach ( $this->value['extra-styles'] as $extra_style ) {
						if ( ! empty( $extra_style ) ) {
							  ...
							  WPGP::$webfonts[ $method ][ $font_family ][ $extra_style ] = $extra_style;
						}
					}
				}
