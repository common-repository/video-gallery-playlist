 ...
 *
 */
if ( ! class_exists( 'WPGP_Abstract' ) ) {
  abstract class WPGP_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        WPGP::$css = apply_filters( "wpgp_{$this->unique}_output_css", WPGP::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'WPGP_Field_' . $field_type;
